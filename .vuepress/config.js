...
module.exports = {
    title: 'c4sc\'s website',
	description: 'blogs, tutorials, probably more.',
    head: [
		['meta', {
			name: 'theme-color',
			content: '#ffffff',
    ...
    themeConfig: {
        ...
        },
		{
			...
			sidebarDepth: 1,
			children: [
				['/updates/117', 'VTubers: How Deep Am I In The Rabbit Hole?'],
				['/updates/java-8-ios', 'VTubers: The difference between 2D and 3D'],
        ...
        },
        {
        	...
        	sidebarDepth: 1,
        	children: [
        		['/contribution/launchers.md', 'Going back to the main page'],
        		['/contribution/website.md', 'Acknowledgments'],
        	]
        },
		],
    },
